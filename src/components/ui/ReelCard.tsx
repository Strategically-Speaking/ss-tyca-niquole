...
export default function ReelCard({ reel, index }: ReelCardProps) {
  ...
  return (
    <div className="group relative aspect-[9/16] overflow-hidden rounded-2xl bg-foreground/5">
      <Image
        src={placeholderImage(`tyca-reel-${index}`, 450, 800)}
        alt={isPlaceholder ? `Placeholder — ${platformLabel[reel.platform]} coming soon` : reel.caption}
        fill
